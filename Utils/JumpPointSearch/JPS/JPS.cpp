...
void FindPath(HWND hWnd)
{
    ...
    if ((nowDir & LL) == LL)
    {
        ...
        while (1)
        {
            ...
            if (IsCorner(LL, nextY, nextX) == false && (nextX == nowNode->_x && nextY == nowNode->_y) == false)
                continue;
            ...
            else
            {
                ...
                // 옵션 방향
                if (g_Tile[newNode->_y + 1][newNode->_x] == OBSTACLE && g_Tile[newNode->_y + 1][newNode->_x - 1] == NONE)
    ...
    if ((nowDir & UU) == UU)
    {
        ...
        while (1)
        {
            ...
            if (IsCorner(UU, nextY, nextX) == false && (nextX == nowNode->_x && nextY == nowNode->_y) == false)
                continue;
            ...
            else
            {
                ...
                // 옵션 방향
                if (g_Tile[newNode->_y][newNode->_x - 1] == OBSTACLE && g_Tile[newNode->_y - 1][newNode->_x - 1] == NONE)
                    newNode->_dir = newNode->_dir | LU;
                if (g_Tile[newNode->_y][newNode->_x + 1] == OBSTACLE && g_Tile[newNode->_y - 1][newNode->_x + 1] == NONE)
    ...
    if ((nowDir & RR) == RR)
    {
        ...
        while (1)
        {
            ...
            if (IsCorner(RR, nextY, nextX) == false && (nextX == nowNode->_x && nextY == nowNode->_y) == false)
                continue;
    ...
    if ((nowDir & DD) == DD)
    {
        ...
        while (1)
        {
            ...
            if (IsCorner(DD, nextY, nextX) == false && (nextX == nowNode->_x && nextY == nowNode->_y) == false)
                continue;
...
bool IsCorner(unsigned int dir, int y, int x)
{
    if ((dir & LL) == LL)
    {
        if (g_Tile[y + 1][x] == OBSTACLE && g_Tile[y + 1][x - 1] == NONE ||
            g_Tile[y - 1][x] == OBSTACLE && g_Tile[y - 1][x - 1] == NONE)
            return true;
        else
            return false;
    }
    if ((dir & LU) == LU)
    {
        if (g_Tile[y][x + 1] == OBSTACLE && g_Tile[y - 1][x + 1] == NONE ||
            g_Tile[y + 1][x] == OBSTACLE && g_Tile[y + 1][x - 1] == NONE)
            return true;
        else
            return false;
    ...
    {
        if (g_Tile[y][x - 1] == OBSTACLE && g_Tile[y - 1][x - 1] == NONE ||
            g_Tile[y][x + 1] == OBSTACLE && g_Tile[y - 1][x + 1] == NONE)
            return true;
        else
            return false;
    }
